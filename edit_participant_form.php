...
if (isset($_GET['id']) && is_numeric($_GET['id'])) {
    ...
    $query = "SELECT id, firstname, surname, email, kills, deaths FROM participant WHERE id = $id";
...
<head>
    ...
    <title>Edit Participant - UK E-Sports League Admin</title>
        ...
        <main class="main-content">
            <div class="header">
                <div class="page-title">
                    ...
                    <p style="color: #64748B; margin-top: 0.5rem;">Update player statistics and information</p>
                </div>
                <div class="user-menu">
            ...
            <div class="form-card">
                <div class="form-header">
                    <h2><i class="fas fa-user-edit" style="color: #3B82F6;"></i> Player Details</h2>
                </div>
                ...
                <div class="form-body">
                    <?php if (!empty($error) || isset($_GET['error'])): ?>
                        <div class="alert alert-error">
                            ...
                            if (isset($_GET['error'])) {
                                $error_messages = [
                                    'invalid' => 'Please enter valid numbers for kills and deaths (0 or higher).',
                                    'db' => 'Database error. Please try again.',
                                    'notfound' => 'Participant not found.',
                                    'noid' => 'No participant ID provided.'
                                ];
                                echo htmlspecialchars($error_messages[$_GET['error']] ?? 'An error occurred.');
                            } else {
                        ...
                        <form action="edit_participant.php" method="POST">
                            ...
                            <div class="form-grid">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="firstname" class="form-control" value="<?php echo htmlspecialchars($participant['firstname']); ?>" required>
                                </div>
                                
                                <div class="form-group">
                                    <label class="form-label">Surname</label>
                                    <input type="text" name="surname" class="form-control" value="<?php echo htmlspecialchars($participant['surname']); ?>" required>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" id="kills" name="kills" class="form-control" value="<?php echo (int)$participant['kills']; ?>" min="0" required>
                                </div>
                                
                                <div class="form-group">
                                    <label for="deaths" class="form-label">Deaths</label>
                                    <input type="number" id="deaths" name="deaths" class="form-control" value="<?php echo (int)$participant['deaths']; ?>" min="0" required>
                                </div>
                            </div>
